...
<div id="layout" class="pure-g">
    <div class="sidebar pure-u-1 pure-u-md-1-4">
        <div class="header">
            <h1 class="brand-title">BASIC AUTH</h1>
            <h2 class="brand-tagline">pawered by rnw</h2>
            ...
            <nav class="nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                    	<a class="pure-button" href="./basicAuth.php">BASIC AUTH</a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <div class="content pure-u-1 pure-u-md-3-4">
        ...
        <div class="pasts">
        	BASIC AUTH
        	<?php 
        	if (isset($_SESSION['lh_basicAuth_err'])){
        		if ($_SESSION['lh_basicAuth_err']==1){
        			echo "<h1 class='content-subhead'>ベーシック認証に失敗しました。</h1>";
        		}else{
        			echo "<h1 class='content-subhead'>ベーシック認証をしてください。</h1>";
        		}
        	}else{
        		echo "<h1 class='content-subhead'>ベーシック認証をしてください。</h1>";
        	}
            ...
            <!-- <div class="posts">
                ...
                <section class="post">
                    ...
                    <div class="post-description">
                        <p>
                            Yesterday at CSSConf, we launched Pure 窶� a new CSS library. Phew! Here are the <a href="https://speakerdeck.com/tilomitra/pure-bliss">slides from the presentation</a>. Although it looks pretty minimalist, we窶况e been working on Pure for several months. After many iterations, we have released Pure as a set of small, responsive, CSS modules that you can use in every web project.
                        </p>
                    </div>
                </section>
            </div>
            ...
            <div class="posts">
                ...
                <section class="post">
                    ...
                    <div class="post-description">
                        <p>
                            We are happy to announce the release of YUI 3.10.2! You can find it now on the Yahoo! CDN, download it directly, or pull it in via npm. We窶况e also updated the YUI Library website with the latest documentation.
                        </p>
                    </div>
                </section>
            </div> -->
